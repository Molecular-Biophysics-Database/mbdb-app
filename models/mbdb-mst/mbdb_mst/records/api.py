...
class MbdbMstRecord(InvenioRecord):
    ...
    relations = RelationsField(
        ...
        expression_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Polymer.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Molecular"
            " assembly.components.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        Polymer_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Molecular"
            " assembly.components.Polymer.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        Body_fluid_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Complex"
            " substance of biological origin.Body fluid.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        Cell_fraction_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Complex"
            " substance of biological origin.Cell fraction.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        host_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Complex"
            " substance of biological origin.Virion.host_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        Virion_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Complex"
            " substance of biological origin.Virion.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        components_Polymer_expression_organism=PIDRelation(
            ...
            " origin.details.components.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        components_Polymer_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.constituents.Complex"
            " substance of chemical origin.details.components.Polymer.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        solvent_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.solvent.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        solvent_Polymer_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.solvent.Polymer.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        Molecular_assembly_components_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.chemical_environments.solvent.Molecular"
            " assembly.components.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        ...
        entities_of_interest_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.entities_of_interest.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        entities_of_interest_Polymer_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.entities_of_interest.Polymer.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        entities_of_interest_Molecular_assembly_components_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.entities_of_interest.Molecular"
            " assembly.components.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        ...
        Complex_substance_of_biological_origin_Body_fluid_organism=PIDRelation(
            "metadata.general_parameters.chemical_information.entities_of_interest.Complex"
            " substance of biological origin.Body fluid.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        ...
        sample_composition_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.instrument.performance_test.sample_composition.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        sample_composition_Polymer_organism=PIDRelation(
            "metadata.general_parameters.instrument.performance_test.sample_composition.Polymer.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        sample_composition_Molecular_assembly_components_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.instrument.performance_test.sample_composition.Molecular"
            " assembly.components.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        ...
        sample_composition_Complex_substance_of_biological_origin_Body_fluid_organism=PIDRelation(
            "metadata.general_parameters.instrument.performance_test.sample_composition.Complex"
            " substance of biological origin.Body fluid.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        ...
        composition_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.physical_environment_at_sample_handling.atmosphere.composition.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        composition_Polymer_organism=PIDRelation(
            "metadata.general_parameters.physical_environment_at_sample_handling.atmosphere.composition.Polymer.organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
        composition_Molecular_assembly_components_Polymer_expression_organism=PIDRelation(
            "metadata.general_parameters.physical_environment_at_sample_handling.atmosphere.composition.Molecular"
            " assembly.components.Polymer.expression_organism",
            keys=["id", "title", {"key": "props.rank", "target": "rank"}],
            pid_field=Vocabulary.pid.with_type_ctx("organisms"),
        ),
