...
def create_api_blueprint(app):
    """Create MbdbBliRecord blueprint."""
    blueprint = app.extensions["mbdb_bli"].resource_records.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_mbdb_bli") and callable(v)
    ]
    for func in funcs:
...
def init_addons_mbdb_bli_published_service(state):
    """Init app."""
    app = state.app
    ext = app.extensions["mbdb_bli"]
