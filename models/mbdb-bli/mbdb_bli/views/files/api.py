...
def create_api_blueprint(app):
    """Create MbdbBliFile blueprint."""
    blueprint = app.extensions["mbdb_bli"].resource_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_mbdb_bli_file") and callable(v)
    ]
    for func in funcs:
...
def init_addons_mbdb_bli_file_published_service(state):
    """Init app."""
    app = state.app
    ext = app.extensions["mbdb_bli"]
