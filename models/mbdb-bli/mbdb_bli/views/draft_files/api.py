...
def create_api_blueprint(app):
    """Create MbdbBliFileDraft blueprint."""
    blueprint = app.extensions["mbdb_bli"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_mbdb_bli_file_draft") and callable(v)
    ]
    for func in funcs:
