...
class MbdbBliUISchema(InvenioUISchema):
    ...
    metadata = ma_fields.Nested(lambda: MbdbBliMetadataUISchema())


class MbdbBliMetadataUISchema(Schema):
    class Meta:
        unknown = ma.RAISE
...
class PlatesItemUISchema(Schema):
    class Meta:
        unknown = ma.RAISE
...
class SensorsItemUISchema(Schema):
    class Meta:
        unknown = ma.RAISE
...
class MeasuredDataUISchema(Schema):
    ...
    response = ma_fields.Nested(lambda: ResponseUISchema(), required=True)

    time = ma_fields.Nested(lambda: ResponseUISchema(), required=True)
...
class ShakingSpeedUISchema(Schema):
    class Meta:
        unknown = ma.RAISE
...
class SurfaceModificationUISchema(Schema):
    class Meta:
        unknown = ma.RAISE
