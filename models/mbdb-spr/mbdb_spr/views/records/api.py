...
def create_api_blueprint(app):
    """Create MbdbSprRecord blueprint."""
    blueprint = app.extensions["mbdb_spr"].resource_records.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_mbdb_spr") and callable(v)
    ]
    for func in funcs:
...
def init_addons_mbdb_spr_published_service(state):
    """Init app."""
    app = state.app
    ext = app.extensions["mbdb_spr"]
