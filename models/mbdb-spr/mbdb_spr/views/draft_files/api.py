...
def create_api_blueprint(app):
    """Create MbdbSprFileDraft blueprint."""
    blueprint = app.extensions["mbdb_spr"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_mbdb_spr_file_draft") and callable(v)
    ]
    for func in funcs:
