...
metadata_method_specific_parameters_mode_buffer_flowrate_rate = TermsFacet(
    field="metadata.method_specific_parameters.mode.buffer_flowrate.rate",
    label=_("metadata/method_specific_parameters/mode/buffer_flowrate/rate.label"),
)
...
metadata_method_specific_parameters_mode_flow_cell_rate = TermsFacet(
    field="metadata.method_specific_parameters.mode.flow_cell.rate",
    label=_("metadata/method_specific_parameters/mode/flow_cell/rate.label"),
)
...
metadata_method_specific_parameters_mode_sample_flowrate_rate = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_flowrate.rate",
    label=_("metadata/method_specific_parameters/mode/sample_flowrate/rate.label"),
)
