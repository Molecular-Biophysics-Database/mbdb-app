...
metadata_method_specific_parameters_calibrants_modifications_position = TermsFacet(
    ...
    label=_(
        "metadata/method_specific_parameters/calibrants/modifications/position.label"
    ),
)

metadata_method_specific_parameters_calibrants_modifications_protocol_description = TermsFacet(
    field="metadata.method_specific_parameters.calibrants.modifications.protocol.description",
    label=_(
        "metadata/method_specific_parameters/calibrants/modifications/protocol/description.label"
    ),
)

metadata_method_specific_parameters_calibrants_modifications_protocol_name = TermsFacet(
    field="metadata.method_specific_parameters.calibrants.modifications.protocol.name",
    label=_(
        "metadata/method_specific_parameters/calibrants/modifications/protocol/name.label"
    ),
)

metadata_method_specific_parameters_calibrants_modifications_type = TermsFacet(
    field="metadata.method_specific_parameters.calibrants.modifications.type",
    label=_("metadata/method_specific_parameters/calibrants/modifications/type.label"),
)

metadata_method_specific_parameters_calibrants_molecular_weight_unit = TermsFacet(
    field="metadata.method_specific_parameters.calibrants.molecular_weight.unit",
    label=_(
        "metadata/method_specific_parameters/calibrants/molecular_weight/unit.label"
    ),
)

metadata_method_specific_parameters_calibrants_molecular_weight_value = TermsFacet(
    field="metadata.method_specific_parameters.calibrants.molecular_weight.value",
    label=_(
        "metadata/method_specific_parameters/calibrants/molecular_weight/value.label"
    ),
)
...
metadata_method_specific_parameters_calibrants_type = TermsFacet(
    field="metadata.method_specific_parameters.calibrants.type",
    label=_("metadata/method_specific_parameters/calibrants/type.label"),
)
...
metadata_method_specific_parameters_measurements_duration_unit = TermsFacet(
    field="metadata.method_specific_parameters.measurements.duration.unit",
    label=_("metadata/method_specific_parameters/measurements/duration/unit.label"),
)

metadata_method_specific_parameters_measurements_duration_value = TermsFacet(
    field="metadata.method_specific_parameters.measurements.duration.value",
    label=_("metadata/method_specific_parameters/measurements/duration/value.label"),
)
...
metadata_method_specific_parameters_measurements_temperature_value = TermsFacet(
    field="metadata.method_specific_parameters.measurements.temperature.value",
    label=_("metadata/method_specific_parameters/measurements/temperature/value.label"),
)

metadata_method_specific_parameters_mode_buffer_flowrate_unit = TermsFacet(
    field="metadata.method_specific_parameters.mode.buffer_flowrate.unit",
    label=_("metadata/method_specific_parameters/mode/buffer_flowrate/unit.label"),
)

metadata_method_specific_parameters_mode_buffer_flowrate_value = TermsFacet(
    field="metadata.method_specific_parameters.mode.buffer_flowrate.value",
...
metadata_method_specific_parameters_mode_sample_flowrate_unit = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_flowrate.unit",
    label=_("metadata/method_specific_parameters/mode/sample_flowrate/unit.label"),
)

metadata_method_specific_parameters_mode_sample_flowrate_value = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_flowrate.value",
    label=_("metadata/method_specific_parameters/mode/sample_flowrate/value.label"),
)

metadata_method_specific_parameters_mode_type = TermsFacet(
    field="metadata.method_specific_parameters.mode.type",
    label=_("metadata/method_specific_parameters/mode/type.label"),
)

metadata_method_specific_parameters_mode_sample_carrier_cleaning_protocol_description = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_carrier.cleaning_protocol.description",
    label=_(
        "metadata/method_specific_parameters/mode/sample_carrier/cleaning_protocol/description.label"
    ),
)

metadata_method_specific_parameters_mode_sample_carrier_cleaning_protocol_name = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_carrier.cleaning_protocol.name",
    label=_(
        "metadata/method_specific_parameters/mode/sample_carrier/cleaning_protocol/name.label"
    ),
)

metadata_method_specific_parameters_mode_sample_carrier_material = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_carrier.material",
    label=_("metadata/method_specific_parameters/mode/sample_carrier/material.label"),
)

metadata_method_specific_parameters_mode_sample_carrier_supplier_catalog_number = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_carrier.supplier.catalog_number",
    label=_(
        "metadata/method_specific_parameters/mode/sample_carrier/supplier/catalog_number.label"
    ),
)

metadata_method_specific_parameters_mode_sample_carrier_supplier_further_information = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_carrier.supplier.further_information",
    label=_(
        "metadata/method_specific_parameters/mode/sample_carrier/supplier/further_information.label"
    ),
)

metadata_method_specific_parameters_mode_sample_carrier_supplier_name = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_carrier.supplier.name",
    label=_(
        "metadata/method_specific_parameters/mode/sample_carrier/supplier/name.label"
    ),
)

metadata_method_specific_parameters_mode_sample_carrier_surface_modification = TermsFacet(
    field="metadata.method_specific_parameters.mode.sample_carrier.surface_modification",
    label=_(
        "metadata/method_specific_parameters/mode/sample_carrier/surface_modification.label"
    ),
)
