...
class ItcRecord(InvenioRecord):
    ...
    index = IndexField("itc-itc-1.0.0")
    ...
    relations = RelationsField(
        ...
        chemical=PIDRelation(
            "metadata.general_parameters.chemical_environments.constituents.chemical",
            keys=[
                "id",
                "title",
                {"key": "props.inchikey", "target": "inchikey"},
                {"key": "props.molecular_formula", "target": "molecular_formula"},
                {"key": "props.molecular_weight", "target": "molecular_weight"},
                {
                    "key": "props.additional_identifiers",
                    "target": "additional_identifiers",
                },
            ],
            pid_field=Vocabulary.pid.with_type_ctx("chemical"),
        ),
        ...
        Chemical_chemical=PIDRelation(
            "metadata.general_parameters.chemical_environments.constituents.components.chemical",
            keys=[
                "id",
                "title",
                {"key": "props.inchikey", "target": "inchikey"},
        ...
        components_Chemical_chemical=PIDRelation(
            "metadata.general_parameters.chemical_environments.constituents.components.chemical",
            keys=[
                "id",
                "title",
        ...
        solvent_Chemical_chemical=PIDRelation(
            "metadata.general_parameters.chemical_environments.solvent.chemical",
            keys=[
                "id",
                "title",
                {"key": "props.inchikey", "target": "inchikey"},
        ...
        entities_of_interest_Chemical_chemical=PIDRelation(
            "metadata.general_parameters.entities_of_interest.chemical",
            keys=[
                "id",
                "title",
                {"key": "props.inchikey", "target": "inchikey"},
        ...
        Molecular_assembly_components_Chemical_chemical=PIDRelation(
            "metadata.general_parameters.entities_of_interest.components.chemical",
            keys=[
                "id",
                "title",
                {"key": "props.inchikey", "target": "inchikey"},
        ...
        Lipid_assembly_components_Chemical_chemical=PIDRelation(
            "metadata.general_parameters.entities_of_interest.components.chemical",
            keys=[
                "id",
                "title",
        ...
        instrument=PIDRelation(
            ...
            keys=[
                ...
                {"key": "props.technique", "target": "technique"},
            ],
            pid_field=Vocabulary.pid.with_type_ctx("instrument"),
        ),
...
class ItcDraft(InvenioDraft):
    ...
    index = IndexField("itc-itc_draft-1.0.0")
...
ItcRecord.has_draft = HasDraftCheckField(
    draft_cls=ItcDraft, config_key="HAS_DRAFT_CUSTOM_FIELD"
)
