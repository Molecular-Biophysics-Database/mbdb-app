...
class ItcSearchOptions(I18nRDMSearchOptions):
    ...
    facets = {
        ...
        "metadata_method_specific_parameters_cell_temperature_value": (
            facets.metadata_method_specific_parameters_cell_temperature_value
        ),
        "metadata_method_specific_parameters_cell_volume_unit": (
            facets.metadata_method_specific_parameters_cell_volume_unit
        ),
        "metadata_method_specific_parameters_cell_volume_value": (
            facets.metadata_method_specific_parameters_cell_volume_value
        ),
        ...
        "metadata_method_specific_parameters_data_analysis_type": (
            facets.metadata_method_specific_parameters_data_analysis_type
        ),
        "metadata_method_specific_parameters_feedback_mode": (
            facets.metadata_method_specific_parameters_feedback_mode
        ),
        "metadata_method_specific_parameters_injection_mode_type": (
            facets.metadata_method_specific_parameters_injection_mode_type
        ),
        "metadata_method_specific_parameters_injection_mode_volume_unit": (
            facets.metadata_method_specific_parameters_injection_mode_volume_unit
        ),
        "metadata_method_specific_parameters_injection_mode_volume_value": (
            facets.metadata_method_specific_parameters_injection_mode_volume_value
        ),
        "metadata_method_specific_parameters_injection_mode_injection_parameters_n_injections": (
            facets.metadata_method_specific_parameters_injection_mode_injection_parameters_n_injections
        ),
        "metadata_method_specific_parameters_injection_mode_injection_parameters_volume_unit": (
            facets.metadata_method_specific_parameters_injection_mode_injection_parameters_volume_unit
        ),
        "metadata_method_specific_parameters_injection_mode_injection_parameters_volume_value": (
            facets.metadata_method_specific_parameters_injection_mode_injection_parameters_volume_value
        ),
        "metadata_method_specific_parameters_injection_mode_number_injections": (
            facets.metadata_method_specific_parameters_injection_mode_number_injections
        ),
        "metadata_method_specific_parameters_measurements_sample_in_cell_preparation_protocol_description": (
            facets.metadata_method_specific_parameters_measurements_sample_in_cell_preparation_protocol_description
        ),
        "metadata_method_specific_parameters_measurements_sample_in_cell_preparation_protocol_name": (
            facets.metadata_method_specific_parameters_measurements_sample_in_cell_preparation_protocol_name
        ),
        "metadata_method_specific_parameters_measurements_sample_in_cell_targets_concentration_unit": (
            facets.metadata_method_specific_parameters_measurements_sample_in_cell_targets_concentration_unit
        ),
        "metadata_method_specific_parameters_measurements_sample_in_cell_targets_concentration_value": (
            facets.metadata_method_specific_parameters_measurements_sample_in_cell_targets_concentration_value
        ),
        "metadata_method_specific_parameters_measurements_sample_in_syringe_preparation_protocol_description": (
            facets.metadata_method_specific_parameters_measurements_sample_in_syringe_preparation_protocol_description
        ),
        "metadata_method_specific_parameters_measurements_sample_in_syringe_preparation_protocol_name": (
            facets.metadata_method_specific_parameters_measurements_sample_in_syringe_preparation_protocol_name
        ),
        "metadata_method_specific_parameters_measurements_sample_in_syringe_targets_concentration_unit": (
            facets.metadata_method_specific_parameters_measurements_sample_in_syringe_targets_concentration_unit
        ),
        "metadata_method_specific_parameters_measurements_sample_in_syringe_targets_concentration_value": (
            facets.metadata_method_specific_parameters_measurements_sample_in_syringe_targets_concentration_value
        ),
        "metadata_method_specific_parameters_reference_power_unit": (
            facets.metadata_method_specific_parameters_reference_power_unit
        ),
        "metadata_method_specific_parameters_reference_power_value": (
            facets.metadata_method_specific_parameters_reference_power_value
        ),
        "metadata_method_specific_parameters_schema_version": (
            facets.metadata_method_specific_parameters_schema_version
        ),
        "metadata_method_specific_parameters_stirring_speed_unit": (
            facets.metadata_method_specific_parameters_stirring_speed_unit
        ),
        "metadata_method_specific_parameters_stirring_speed_value": (
            facets.metadata_method_specific_parameters_stirring_speed_value
        ),
...
class ItcDraftSearchOptions(I18nRDMDraftsSearchOptions):
    """ItcDraft search options."""
