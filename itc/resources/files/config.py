...
class ItcFileResourceConfig(FileResourceConfig):
    ...
    def response_handlers(self):
        ...
        return {
            ...
            "application/vnd.inveniordm.v1+json": ExportableResponseHandler(
                ...
                serializer=ItcFileUIJSONSerializer(),
            ),
            **entrypoint_response_handlers,
        }
    ...
    def request_body_parsers(self):
        ...
        for x in importlib_metadata.entry_points(
            group="invenio.itc_files.request_bodyparsers"
        ):
...
class ItcFileDraftResourceConfig(FileResourceConfig):
    ...
    def response_handlers(self):
        ...
        return {
            ...
            "application/vnd.inveniordm.v1+json": ExportableResponseHandler(
                export_code="ui_json",
                name=_("Native UI JSON"),
                serializer=ItcFileDraftUIJSONSerializer(),
            ),
            **entrypoint_response_handlers,
        }
    ...
    def request_body_parsers(self):
        entrypoint_request_bodyparsers = {}
        for x in importlib_metadata.entry_points(
            group="invenio.itc_draft_files.request_bodyparsers"
        ):
            entrypoint_request_bodyparsers.update(x.load())
        return {
            **super().request_body_parsers,
