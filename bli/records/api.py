...
class BliParentRecord(RDMParent):
...
class BliIdProvider(UniversalPIDMixin, DraftRecordIdProviderV2):
    pid_type = "bli"
...
class RDMRecordMediaFiles(BliRecord):
...
class RDMDraftMediaFiles(BliDraft):
