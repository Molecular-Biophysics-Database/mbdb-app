...
class BliSchema(RequestsSchemaMixin, BaseRecordSchema):
    class Meta:
        unknown = ma.RAISE
...
class BliMetadataSchema(Schema):
    class Meta:
        unknown = ma.RAISE
...
class PlatesItemSchema(DictOnlySchema):
    class Meta:
        unknown = ma.RAISE
...
class SensorsItemSchema(DictOnlySchema):
    class Meta:
        unknown = ma.RAISE
...
class SurfaceModificationSchema(DictOnlySchema):
    class Meta:
        unknown = ma.RAISE
