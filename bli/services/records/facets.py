...
metadata_method_specific_parameters_sensors_ligand_immobilization_chemistry = TermsFacet(
    field="metadata.method_specific_parameters.sensors.ligand.immobilization_chemistry",
    label=_(
        "metadata/method_specific_parameters/sensors/ligand/immobilization_chemistry.label"
    ),
)

metadata_method_specific_parameters_sensors_ligand_immobilization_protocol_description = TermsFacet(
    field="metadata.method_specific_parameters.sensors.ligand.immobilization_protocol.description",
    label=_(
        "metadata/method_specific_parameters/sensors/ligand/immobilization_protocol/description.label"
    ),
)

metadata_method_specific_parameters_sensors_ligand_immobilization_protocol_name = TermsFacet(
    field="metadata.method_specific_parameters.sensors.ligand.immobilization_protocol.name",
    label=_(
        "metadata/method_specific_parameters/sensors/ligand/immobilization_protocol/name.label"
    ),
)
