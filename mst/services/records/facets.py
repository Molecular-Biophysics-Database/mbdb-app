...
metadata_method_specific_parameters_measurements_sample_measurement_container = TermsFacet(
    field="metadata.method_specific_parameters.measurements.sample.measurement_container",
    label=_(
        "metadata/method_specific_parameters/measurements/sample/measurement_container.label"
    ),
)
...
metadata_method_specific_parameters_temperature_unit = TermsFacet(
    field="metadata.method_specific_parameters.temperature.unit",
    label=_("metadata/method_specific_parameters/temperature/unit.label"),
)

metadata_method_specific_parameters_temperature_value = TermsFacet(
    field="metadata.method_specific_parameters.temperature.value",
