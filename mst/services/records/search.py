...
class MstSearchOptions(RecordSearchOptions):
    ...
    facets = {
        ...
        "metadata_method_specific_parameters_temperature_unit": (
            facets.metadata_method_specific_parameters_temperature_unit
        ),
        "metadata_method_specific_parameters_temperature_value": (
            facets.metadata_method_specific_parameters_temperature_value
        ),
