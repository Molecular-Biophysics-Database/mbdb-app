...
class MstExt:
    ...
    def service_records(self):
        service_config = build_config(config.MST_RECORD_SERVICE_CONFIG, self.app)
    ...
    def resource_records(self):
        return config.MST_RECORD_RESOURCE_CLASS(
            ...
            config=build_config(config.MST_RECORD_RESOURCE_CONFIG, self.app),
        )
    ...
    def service_record_request_types(self):
        return config.MST_REQUEST_TYPES_SERVICE_CLASS(
            record_service=self.service_records,
            oarepo_requests_service=current_oarepo_requests_service,
        )
    ...
    def resource_record_request_types(self):
        return config.MST_REQUEST_TYPES_RESOURCE_CLASS(
    ...
    def service_files(self):
        service_config = build_config(config.MST_FILES_SERVICE_CONFIG, self.app)
    ...
    def resource_files(self):
        return config.MST_FILES_RESOURCE_CLASS(
            ...
            config=build_config(config.MST_FILES_RESOURCE_CONFIG, self.app),
        )

    @cached_property
    def service_draft_files(self):
        service_config = build_config(config.MST_DRAFT_FILES_SERVICE_CONFIG, self.app)
    ...
    def resource_draft_files(self):
        return config.MST_DRAFT_FILES_RESOURCE_CLASS(
            ...
            config=build_config(config.MST_DRAFT_FILES_RESOURCE_CONFIG, self.app),
        )
...
RDM_MODEL_CONFIG = {  # allows merging stuff from other builders
    ...
    "api_service": "mst.services.records.service.MstService",
    "api_service_config": "mst.services.records.config.MstServiceConfig",
    "api_resource": "mst.resources.records.resource.MstResource",
    "api_resource_config": "mst.resources.records.config.MstResourceConfig",
    "ui_resource_config": "ui.mst.MstUIResourceConfig",
    "record_cls": "mst.records.api.MstRecord",
    "pid_type": "mst",
    "draft_cls": "mst.records.api.MstDraft",
}
