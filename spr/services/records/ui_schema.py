...
class SprUISchema(UIRequestsSerializationMixin, InvenioUISchema):
    class Meta:
        unknown = ma.RAISE
...
class MeasurementPositionsItemUISchema(DictOnlySchema):
    class Meta:
        unknown = ma.RAISE
...
class ReferenceSamplesItemUISchema(DictOnlySchema):
    class Meta:
        unknown = ma.RAISE
...
class LigandInformationUISchema(DictOnlySchema):
    class Meta:
        unknown = ma.RAISE
...
class SensorUISchema(DictOnlySchema):
    class Meta:
        unknown = ma.RAISE
