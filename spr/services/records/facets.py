...
metadata_method_specific_parameters_measurement_protocol_type = TermsFacet(
    ...
    label=_("Measurement protocol type"),
)
...
metadata_method_specific_parameters_measurements_reference_samples_position = TermsFacet(
    ...
    label=_("Reference sample position"),
)

metadata_method_specific_parameters_measurements_reference_samples_preparation_protocol_description = TermsFacet(
    field="metadata.method_specific_parameters.measurements.reference_samples.preparation_protocol.description",
    label=_(
        "metadata/method_specific_parameters/measurements/reference_samples/preparation_protocol/description.label"
    ),
)

metadata_method_specific_parameters_measurements_reference_samples_preparation_protocol_name = TermsFacet(
    field="metadata.method_specific_parameters.measurements.reference_samples.preparation_protocol.name",
    label=_(
        "metadata/method_specific_parameters/measurements/reference_samples/preparation_protocol/name.label"
    ),
)
...
metadata_method_specific_parameters_measurements_samples_position = TermsFacet(
    ...
    label=_("Sample position"),
)

metadata_method_specific_parameters_measurements_samples_preparation_protocol_description = TermsFacet(
    field="metadata.method_specific_parameters.measurements.samples.preparation_protocol.description",
    label=_(
        "metadata/method_specific_parameters/measurements/samples/preparation_protocol/description.label"
    ),
)

metadata_method_specific_parameters_measurements_samples_preparation_protocol_name = TermsFacet(
    field="metadata.method_specific_parameters.measurements.samples.preparation_protocol.name",
    label=_(
        "metadata/method_specific_parameters/measurements/samples/preparation_protocol/name.label"
    ),
)
