...
import { i18next } from "@translations/mst_ui/i18next";
...
export const ResultsListItemComponent = ({
  ...
  const title = _get(result, "metadata.general_parameters.record.title", '<no title>')
  const technique = _get(result, "metadata.general_parameters.technique", '<no technique>')
  const principalContact = _get(result, "metadata.general_parameters.depositors.principal_contact.full_name",
                                '<no contact>')
